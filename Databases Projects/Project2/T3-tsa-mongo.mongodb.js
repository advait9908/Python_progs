...
db.createCollection("tsa_town");

db.tsa_town.insertMany([
...
db.tsa_town.find(
    {
        ...
        {"resorts.company_name":{"$eq":"Tropical Dream"}}]
    }
)
...
// ENSURE that your query is formatted and has a semicolon
// (;) at the end of this answer
db.tsa.updateOne({"resorts.company_name":{"$eq":"Tropical Dream"}},
        {"$set": {"resorts.company_name":"Tropical Heaven"}}
)

db.tsa.find(
        {"resorts.company_name":{"$eq":"Tropical Heaven"}}
)
...
// (;) at the end of this answer
db.tsa.find(
    {"town_name":{"$eq":"Mount Isa, QLD"}},
);

db.tsa_town.updateOne(
    {"town_name":{"$eq":"Mount Isa, QLD"}},
    {"$push":{"resorts":
        {"id":10,
        "name":"Amazing Resort",
        "address":"7 Oakleigh Road",
        "phone":"0433427658",
        "year_built":2022,
